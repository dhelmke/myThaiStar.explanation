...
public class CompositeTransferObjectHandler {
    ...
    public void execute(Shell shell) {
    	...
    	String filename = "TableCto";
    	String website ="https://github.com/devonfw/devon4j/blob/develop/documentation/guide-transferobject.asciidoc";
